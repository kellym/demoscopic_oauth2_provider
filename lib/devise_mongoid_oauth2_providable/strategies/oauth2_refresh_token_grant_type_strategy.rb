require 'devise_mongoid_oauth2_providable/strategies/oauth2_grant_type_strategy'
...
module Devise
  module Strategies
    class Oauth2RefreshTokenGrantTypeStrategy < Oauth2GrantTypeStrategy
      ...
      def authenticate!
        if client && refresh_token = client.refresh_tokens.first(conditions: {token: params[:refresh_token]})
